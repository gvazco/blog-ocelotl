            ...
            <div class="col-12 col-md-8 col-lg-9 p-0 pr-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5">
                        ...
                        <a
                            href="<?php echo $blog["dominio"] . $value["ruta_categoria"] . "/" . $value["ruta_articulo"]; ?>">
                            <h5 class="d-block d-lg-none py-3"><?php echo $value["titulo_articulo"]; ?></h5>
                        </a>

                        <a
                            href="<?php echo $blog["dominio"] . $value["ruta_categoria"] . "/" . $value["ruta_articulo"]; ?>"><img
                                src="<?php echo $blog["servidor"]; ?><?php echo $value["portada_articulo"]; ?>"
                    ...
                    <div class="col-12 col-lg-7 introArticulo">
                        ...
                        <a
                            href="<?php echo $blog["dominio"] . $value["ruta_categoria"] . "/" . $value["ruta_articulo"]; ?>">
                            <h4 class="d-none d-lg-block w-75"><?php echo $value["titulo_articulo"]; ?></h4>
                        </a>
                ...
                <hr class="mb-4 mb-lg-5" style="border: 1px solid #c40000">
                ...
                <div class="container d-none d-md-block">
                    ...
                    <ul class="pagination justify-content-center" totalPaginas="<?php echo $totalPaginas; ?>"
                        paginaActual="<?php echo $paginaActual; ?>" rutaPagina="<?php echo $rutas[0]; ?>"></ul>
                ...
                <div class="my-4">
                    ...
                    <div class="d-flex my-3">
                        ...
                        <div class="w-100 w-xl-50 pr-3 pt-2">
                            ...
                            <a
                                href="<?php echo $blog["dominio"] . $categoria[0]["ruta_categoria"] . "/" . $value["ruta_articulo"]; ?>">
