<aside class="main-sidebar sidebar-dark-primary elevation-4" style="overflow-x:hidden">
    ...
    <a href="{{ url('/') }}" class="brand-link">
        <img src="{{ url('/') }}/{{ $blog[0]['icono'] }}" alt="AdminLTE Logo" class="brand-image img-circle"
            style="opacity: .8">
        <span class="brand-text">Grupo27</span>
    </a>
    ...
    <div
        ...
        <div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 296px;"></div>
                        ...
                        <div class="image">
                            ...
                            @foreach ($administradores as $element)
                                @if ($_COOKIE['email_login'] == $element->email)
                                    @if ($element->foto == '')
                                        <img src="{{ url('/') }}/vistas/img/admin.png"
                                            class="img-circle elevation-2" alt="User Image">
                                    @else
                                        <img src="{{ url('/') }}/{{ $element->foto }}"
                                            class="img-circle elevation-2" alt="User Image">
                                    @endif
                                @endif
                            @endforeach
        ...
        <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
            <div class="os-scrollbar-track">
                <div class="os-scrollbar-handle" style="height: 21.4131%; transform: translate(0px, 0px);"></div>
            </div>
        </div>
